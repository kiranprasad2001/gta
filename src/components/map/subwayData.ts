...
export const SUBWAY_LINES: SubwayLine[] = [
  {
    ...
    stations: [
      ...
      { name: "York Mills", lat: 43.7432, lon: -79.406, code: "13792" },
      { name: "Lawrence", lat: 43.7253, lon: -79.4023, code: "13793" },
      { name: "Eglinton", lat: 43.7046, lon: -79.3989, code: "13795" },
      { name: "Davisville", lat: 43.697, lon: -79.3969, code: "13798" },
      ...
      { name: "Bloor-Yonge", lat: 43.67, lon: -79.3854, code: "13864" },
      ...
      { name: "Lawrence West", lat: 43.7158, lon: -79.444, code: "13836" },
      { name: "Yorkdale", lat: 43.7252, lon: -79.4477, code: "13837" },
      { name: "Wilson", lat: 43.735, lon: -79.4502, code: "13840" },
      ...
      { name: "Vaughan MC", lat: 43.794, lon: -79.5279, code: "15662" },
    ],
  },
  {
    id: 2,
    ...
    stations: [
      ...
      { name: "Bathurst", lat: 43.666, lon: -79.4112, code: "13881" },
      { name: "Spadina", lat: 43.6672, lon: -79.4038, code: "13855" },
      { name: "St George", lat: 43.6683, lon: -79.3997, code: "13856" },
      { name: "Bay", lat: 43.67, lon: -79.3903, code: "13882" },
      { name: "Bloor-Yonge", lat: 43.671, lon: -79.3859, code: "13865" },
      ...
      { name: "Donlands", lat: 43.6808, lon: -79.337, code: "13888" },
      { name: "Greenwood", lat: 43.682, lon: -79.3302, code: "13889" },
      { name: "Coxwell", lat: 43.6839, lon: -79.3234, code: "13890" },
      { name: "Woodbine", lat: 43.6862, lon: -79.3128, code: "13891" },
      { name: "Main Street", lat: 43.689, lon: -79.3016, code: "13892" },
  ...
  },
  {
    ...
    stations: [
      ...
      { name: "Bayview", lat: 43.767, lon: -79.3864, code: "13896" },
      { name: "Bessarion", lat: 43.7693, lon: -79.3764, code: "13897" },
      { name: "Leslie", lat: 43.771, lon: -79.3659, code: "13898" },
  ...
  },
  {
    ...
    stations: [
      { name: "Mount Dennis", lat: 43.688, lon: -79.4857, code: "16067" },
      { name: "Keelesdale", lat: 43.6904, lon: -79.4745, code: "16202" },
      { name: "Caledonia", lat: 43.6923, lon: -79.465, code: "16083" },
      ...
      { name: "Forest Hill", lat: 43.7011, lon: -79.425, code: "16208" },
      { name: "Chaplin", lat: 43.7029, lon: -79.417, code: "16210" },
      ...
      { name: "Don Valley", lat: 43.72, lon: -79.3389, code: "16077" },
      {
  ...
  },
  {
    ...
    stations: [
      ...
      { name: "Albion", lat: 43.738, lon: -79.5873, code: "FW15" },
      { name: "Stevenson", lat: 43.7397, lon: -79.5828, code: "FW14" },
      { name: "Mount Olive", lat: 43.741, lon: -79.5786, code: "FW13" },
      { name: "Rowntree Wood", lat: 43.7432, lon: -79.5721, code: "FW12" },
      { name: "Pearldale", lat: 43.7447, lon: -79.567, code: "FW11" },
      { name: "Duncanwoods", lat: 43.746, lon: -79.562, code: "FW10" },
      ...
      { name: "Norfinch Oakdale", lat: 43.7547, lon: -79.528, code: "FW06" },
